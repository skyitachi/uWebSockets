...
# HelloWorld (non-SSL, non-Zlib compile)
	clang -DLIBUS_USE_LIBUV -DLIBUS_NO_SSL -flto -O3 -c -luv -IuSockets/src uSockets/src/*.c uSockets/src/eventing/*.c
	clang++ -DLIBUS_USE_LIBUV -DLIBUS_NO_SSL -DUWS_NO_ZLIB -flto -O3 -c -std=c++17 -Isrc -IuSockets/src examples/HelloWorld.cpp
	clang++ -flto -O3 -s *.o -o HelloWorld
	rm *.o

# HelloWorldThreaded (non-SSL, non-Zlib compile)
#	clang -DLIBUS_USE_LIBUV -DLIBUS_NO_SSL -flto -O3 -c -IuSockets/src uSockets/src/*.c uSockets/src/eventing/*.c
